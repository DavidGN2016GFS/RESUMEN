...
9) This dataset contains 837 delivery records from several courier companies such as FedEx, DHL, Delhivery, Amazon Logistics, and others. It includes information on package type, vehicle type, delivery mode, region, weather, distance, weight, actual vs. expected time, delivery status, customer rating, and cost. Although it is very complete for analyzing logistics performance and customer satisfaction, it needs cleaning, especially due to wrongly formatted dates (1970) and one incomplete record. 
Kaggle: https://www.kaggle.com/datasets/ayeshaseherr/delivery-logistics-dataset
GitHub:https://github.com/DavidGN2016GFS/delivery-logistics-analysis/releases/tag/v1.0.0
